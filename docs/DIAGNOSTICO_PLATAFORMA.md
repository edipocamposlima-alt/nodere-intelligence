# Diagnóstico NODERI Nexus — 2026-06-17

## Status por módulo

| Módulo | Status | Bloco de correção |
|---|---|---|
| Home pública | OK | Marca revisada para NODERI Nexus. |
...
| Termos/Privacidade | OK local/build | Marca NODERI revisada. |
...
- A marca foi padronizada para NODERI Nexus em textos visíveis, mas nomes técnicos `nodere_*` foram preservados para não quebrar banco, domínio e integrações.
