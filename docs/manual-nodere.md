...
Ao abrir a ficha a partir da Busca de empresas, o NODERE salva o lead ou resolve duplicidade antes de navegar. Se uma URL antiga usar identificador externo do Google Places, Discovery, Apollo, Econodata ou resultado temporário, a API resolve o registro persistido e a página redireciona para o ID interno canônico quando o lead já existe no CRM.
...
- Dashboard usa tom neutro/ativo, Prospecção usa ciano, Empresas usa azul, CRM/Funil e Leads usam verde, Agenda usa azul visível, Propostas usa roxo, Produtos/Serviços usa laranja e Comunicação usa azul claro;
