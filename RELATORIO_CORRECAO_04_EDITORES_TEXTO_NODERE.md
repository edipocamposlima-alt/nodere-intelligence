...
- Frontend buildado em `http://127.0.0.1:3107`.
- Login owner/admin via sessao real.
...
- Desktop 1366px em tema escuro: aprovado.
- Mobile 375px em tema claro: aprovado.
- `/app/proposals`: 2 editores ricos, 2 toolbars, 42 controles, nenhum botao cortado, `globalOverflow: 0`.
- Demais rotas: sem overflow global, sem preview com HTML bruto visivel.
...
- Nao foram criados registros reais de observacao/post/template/proposta nesta rodada para evitar poluir producao; a validacao visual e de API foi feita com sessao real e dados existentes.
