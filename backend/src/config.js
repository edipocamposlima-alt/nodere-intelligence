...
export const config = {
  ...
  googleCalendarClientId: process.env.GOOGLE_CALENDAR_CLIENT_ID || process.env.GOOGLE_WORKSPACE_CLIENT_ID || process.env.GOOGLE_CLIENT_ID || "",
  googleCalendarClientSecret: process.env.GOOGLE_CALENDAR_CLIENT_SECRET || process.env.GOOGLE_WORKSPACE_CLIENT_SECRET || process.env.GOOGLE_CLIENT_SECRET || "",
  googleCalendarRefreshToken: process.env.GOOGLE_CALENDAR_REFRESH_TOKEN || process.env.GOOGLE_WORKSPACE_REFRESH_TOKEN || process.env.GOOGLE_REFRESH_TOKEN || "",
  gmailClientId: process.env.GMAIL_CLIENT_ID || process.env.GOOGLE_WORKSPACE_CLIENT_ID || process.env.GOOGLE_CLIENT_ID || "",
  gmailClientSecret: process.env.GMAIL_CLIENT_SECRET || process.env.GOOGLE_WORKSPACE_CLIENT_SECRET || process.env.GOOGLE_CLIENT_SECRET || "",
  gmailRefreshToken: process.env.GMAIL_REFRESH_TOKEN || process.env.GOOGLE_WORKSPACE_REFRESH_TOKEN || process.env.GOOGLE_REFRESH_TOKEN || "",
  googleDriveClientId: process.env.GOOGLE_DRIVE_CLIENT_ID || process.env.GOOGLE_WORKSPACE_CLIENT_ID || process.env.GOOGLE_CLIENT_ID || "",
  googleDriveClientSecret: process.env.GOOGLE_DRIVE_CLIENT_SECRET || process.env.GOOGLE_WORKSPACE_CLIENT_SECRET || process.env.GOOGLE_CLIENT_SECRET || "",
  googleDriveRefreshToken: process.env.GOOGLE_DRIVE_REFRESH_TOKEN || process.env.GOOGLE_WORKSPACE_REFRESH_TOKEN || process.env.GOOGLE_REFRESH_TOKEN || "",
