...
export const config = {
  ...
  googleWorkspaceClientId: process.env.GOOGLE_WORKSPACE_CLIENT_ID || process.env.GOOGLE_BUSINESS_PROFILE_CLIENT_ID || "",
  googleWorkspaceClientSecret: process.env.GOOGLE_WORKSPACE_CLIENT_SECRET || process.env.GOOGLE_BUSINESS_PROFILE_CLIENT_SECRET || "",
  googleWorkspaceRefreshToken: process.env.GOOGLE_WORKSPACE_REFRESH_TOKEN || "",
