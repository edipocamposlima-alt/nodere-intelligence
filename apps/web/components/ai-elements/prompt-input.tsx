  ...
  return (
    <Tooltip>
      ...
      <TooltipContent side={side}>
        {tooltipContent}
        {shortcut && (
          <span className="ml-2 text-slate-500 dark:text-slate-400">{shortcut}</span>
        )}
      </TooltipContent>
    </Tooltip>
  );
...
export const PromptInputSelectTrigger = ({
  ...
  <SelectTrigger
    className={cn(
      ...
      "hover:bg-slate-100 hover:text-slate-950 aria-expanded:bg-slate-100 aria-expanded:text-slate-950 dark:hover:bg-slate-800 dark:hover:text-slate-50 dark:aria-expanded:bg-slate-800 dark:aria-expanded:text-slate-50",
      className
    )}
    {...props}
  />
