...
const SOLUTION_CARDS = [
  ...
  { icon: "🧠", code: "INTEL", name: "Inteligência", tag: "Dados", color: "#7C3AED", desc: "Pesquise fontes públicas com citações e diagnóstico por IA.", features: ["Pesquisa verificável", "Diagnóstico IA", "Revisão humana"] },
