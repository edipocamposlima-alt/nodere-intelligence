...
const ALL_POSTS = [
  ...
  { tag: "Inteligência", color: "#7C3AED", slug: "pesquisa-comercial-com-fontes", title: "Pesquisa comercial: fatos, fontes e revisão na mesma tela", desc: "Como a NODERE separa fatos de inferências, calcula confiança e exige revisão antes de aplicar dados comerciais.", read: "3 min", date: "Abr 2026" }
];
