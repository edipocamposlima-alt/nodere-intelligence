...
const ALL_POSTS = [
  ...
  { tag: "Engage", color: "#16A34A", slug: "whatsapp-b2b-sem-spam", title: "WhatsApp B2B: como escalar prospecção sem virar spam", desc: "Estratégias de disparos em massa responsáveis, templates que convertem e como usar o inbox do NODERI para gestão de conversas.", read: "5 min", date: "Mai 2026" },
  { tag: "Analytics", color: "#2563EB", slug: "forecast-receita-85-precisao", title: "Forecast de receita: como prever seu faturamento com precisão", desc: "Configure probabilidades por estágio do funil e veja o NODERI calcular automaticamente sua receita prevista.", read: "4 min", date: "Abr 2026" },
