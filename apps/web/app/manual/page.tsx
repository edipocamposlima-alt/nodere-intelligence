...
const sections = [
  ...
  ["12. Enriquecimento CNPJ e decisores", "CNPJ, razão social, decisores, LinkedIn e e-mails dependem de fonte pública ou integrações como Econodata e Apollo. Quando não houver dado confiável, o sistema mostra 'não localizado' para não criar informação falsa."],
  ...
  ["16. Erros comuns", "insufficient_quota indica falta de crédito OpenAI. not_configured indica variável ausente no Render. 401 indica rota protegida ou token. Busca vazia pode indicar limite da API, restrição de chave ou termo muito específico."]
];
