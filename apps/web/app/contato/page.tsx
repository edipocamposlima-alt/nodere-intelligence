...
export const metadata: Metadata = {
  ...
  description: "Fale com a equipe NODERE."
};
    ...
    <SitePageShell>
      ...
      <section className="site-simple-hero">
        <div className="site-container">
          ...
          <h1>Converse com a equipe NODERE.</h1>
      ...
      <section className="site-section">
        <div className="site-container site-contact-grid">
          <article className="site-info-card site-contact-card--form">
            ...
            <p>O formulario envia sua mensagem diretamente para o comercial da NODERE.</p>
            <ContactForm />
          </article>
          <article className="site-info-card">
            ...
            <a className="site-primary" href="mailto:comercial@nodere.com.br?subject=Contato pelo site NODERE">Enviar e-mail</a>
          </article>
          <article className="site-info-card">
