...
const LOGO_CANDIDATES = ["/nodere-logo-light.png", "/nodere-logo-dark.png", "/android-chrome-192x192.png", "/favicon-32x32.png"];
...
async function addHeaderFooter(doc: jsPDF, title: string, logoBase64: string | null) {
  ...
  for (let page = 1; page <= pages; page += 1) {
    ...
    doc.setFontSize(8);
    doc.setTextColor(75, 85, 99);
    doc.text(`Gerado pelo NODERE · ${typeof window !== "undefined" ? window.location.host : "NODERE"}`, 12, 285);
