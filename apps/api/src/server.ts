...
app.use("/api/searches", requireWorkspaceSession, requireModuleAccess("buscas"), searchesRouter);
app.use("/api/search", requireWorkspaceSession, requireModuleAccess("buscas"), searchesRouter);
...
app.use("/api/companies", requireWorkspaceSession, requireModuleAccess("crm"), companiesRouter);
app.use("/api/crm", requireWorkspaceSession, requireModuleAccess("crm"), crmRouter);
...
app.use("/api/dashboard", requireWorkspaceSession, requireModuleAccess("dashboard"), dashboardRouter);
app.use("/api/reports", requireWorkspaceSession, requireModuleAccess("relatorios"), reportsRouter);
app.use("/api/audit", requireWorkspaceRole("owner", "admin"), auditRouter);
app.use("/api/calendar", requireWorkspaceSession, requireModuleAccess("agenda"), calendarRouter);
app.use("/api/catalog", requireWorkspaceSession, requireModuleAccess("crm"), catalogRouter);
...
app.use("/api/integrations", requireWorkspaceSession, requireModuleAccess("integracoes"), integrationsRouter);
app.use("/api/inbox", requireWorkspaceSession, requireModuleAccess("crm"), inboxRouter);
...
app.use("/api/sequences", requireWorkspaceSession, requireModuleAccess("crm"), sequencesRouter);
app.use("/api/operators", requireWorkspaceSession, requireModuleAccess("admin"), operatorsRouter);
