...
const TERMS_SECTIONS = [
  ["1. ACEITAÇÃO DOS TERMOS", "Ao acessar, utilizar ou contratar qualquer serviço disponibilizado pelo NODERE (\"Plataforma\"), o usuário declara ter lido, compreendido e concordado integralmente com os presentes Termos de Uso, bem como com a Política de Privacidade e demais documentos complementares disponibilizados pela plataforma. Caso o usuário não concorde com qualquer disposição destes termos, deverá interromper imediatamente a utilização da plataforma."],
  ["2. SOBRE A PLATAFORMA", "O NODERE é uma plataforma de software como serviço (SaaS) destinada à prospecção comercial, gestão de relacionamento com clientes (CRM), análise de presença digital, automação de processos, geração de documentos, inteligência comercial e utilização de recursos de inteligência artificial. As funcionalidades podem incluir: CRM e funil de vendas; gestão de leads e oportunidades; busca e análise de empresas; integrações com APIs e serviços de terceiros; geração de propostas e contratos; gestão de tarefas e agenda; relatórios e dashboards; recursos de inteligência artificial."],
  ...
  ["6. DADOS EMPRESARIAIS E FONTES PÚBLICAS", "O NODERE poderá utilizar informações provenientes de bases públicas, APIs autorizadas, diretórios empresariais, ferramentas de pesquisa e serviços contratados. O usuário reconhece que disponibilidade, precisão e atualização desses dados dependem das fontes externas. O NODERE não garante exatidão, atualização ou completude de informações de terceiros."],
  ...
  ["9. INTEGRAÇÕES COM TERCEIROS", "A plataforma poderá integrar-se a OpenAI, Google, Google Maps, Google Business Profile, WhatsApp, Stripe, serviços públicos autorizados e serviços de hospedagem. A disponibilidade dessas integrações depende dos respectivos fornecedores."],
  ["10. CREDENCIAIS, TOKENS E CHAVES DE API", "As credenciais são de responsabilidade do usuário. O NODERE adota práticas de segurança incluindo ocultação de secrets, controle de acesso, armazenamento seguro e restrições administrativas."],
  ...
  ["12. DISPONIBILIDADE DA PLATAFORMA", "O NODERE envidará esforços razoáveis para manter a plataforma disponível, sujeita a manutenções programadas, atualizações, falhas de internet, problemas de infraestrutura, incidentes de segurança e falhas de terceiros."],
  ...
  ["14. PROPRIEDADE INTELECTUAL", "Todos os direitos relativos à plataforma pertencem ao NODERE, incluindo código-fonte, interface, layout, logotipos, marca, documentação, funcionalidades, banco de dados e conteúdo proprietário. Nenhum direito é transferido ao usuário."],
  ["15. LIMITAÇÃO DE RESPONSABILIDADE", "O NODERE não será responsável por perdas de negócios, lucros cessantes, danos indiretos, falhas de terceiros, erros em bases externas, decisões comerciais do usuário, conteúdos gerados por IA ou utilização inadequada. A responsabilidade total fica limitada ao valor efetivamente pago nos últimos 12 meses."],
  ...
  ["19. CONTATO", "Dúvidas poderão ser encaminhadas pelos canais oficiais do NODERE."]
];

const PRIVACY_SECTIONS = [
  ["1. APRESENTAÇÃO", "Esta Política de Privacidade explica como o NODERE coleta, usa, armazena, protege e compartilha dados tratados na plataforma SaaS de prospecção, CRM, inteligência comercial, automações, relatórios e integrações."],
  ...
  ["8. INTEGRAÇÕES COM TERCEIROS", "A plataforma pode se integrar com Google, OpenAI, Anthropic, WhatsApp, Stripe, RD Station, Bling, Supabase, fontes públicas autorizadas, serviços de e-mail e hospedagem. Cada integração depende das permissões e políticas do respectivo fornecedor."],
  ...
  ["19. CONTATO E ENCARREGADO", "Dúvidas ou solicitações sobre privacidade e LGPD podem ser encaminhadas pelos canais oficiais do NODERE."]
];
